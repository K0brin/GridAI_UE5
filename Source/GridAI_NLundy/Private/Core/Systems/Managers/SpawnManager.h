...
public:	
	...
	UPROPERTY(EditAnywhere, Category = "Grid_Spawning") float GridWidth = 20;
	...
	//________________________________________PLAYER_SPAWNING______________________________________________
	UFUNCTION(BlueprintCallable, Category = "Player_Spawning") void SpawnPlayer();
